...
<head>
  ...
  <!-- Favicons -->
  <link rel="shortcut icon" href="/frontend/img/logo_domas.png">
  <link rel="apple-touch-icon" href="/frontend/img/logo_domas.png">
  <link rel="apple-touch-icon" sizes="72x72" href="/frontend/img/logo_domas.png">
  <link rel="apple-touch-icon" sizes="114x114" href="/frontend/img/logo_domas.png">
          ...
          <div class="container relative">
            ...
            <div class="row flex-parent">
              ...
              <div class="navbar-header flex-child">
                ...
                <!-- Mobile cart -->
                <li class="nav-cart mobile-cart hidden-lg hidden-md">
                ...
                <li class="nav-cart mobile-cart hidden-lg hidden-md">
                  <div class="nav-cart-outer">
                    <div class="nav-cart-inner">
                      <a href="/orders" class="fa fa-shopping-bag"></a>
                    </div>
                  </div>
                </li>
                        ...
                        <li>
                          <div class="megamenu-wrap container">
                            <div class="row">
                              ...
                              <div class="col-md-2 megamenu-item">
                                <ul class="menu-list">
                                  <li>
              ...
              <div class="flex-child flex-right nav-right hidden-sm hidden-xs">
                <ul>
                  ...
                  <li class="nav-register">
                    ...
                    <a>{{Auth::guard('webmember')->user()->nama_member}}</a>
                    @else
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="widget footer-about-us">
                  <img src="/frontend/img/logo_domas.png" alt="" class="logo">
                </div>
              </div> <!-- end about us -->
              ...
              <div class="col-md-2 col-md-offset-1 col-sm-6 col-xs-12">
                <div class="widget footer-links">
                  ...
                  <ul class="list-no-dividers">
                    <li><a href="/frontend/#">Our stores</a></li>
                    <li><a href="/frontend/#">About us</a></li>
                    <li><a href="/frontend/#">Business with us</a></li>
              ...
              <div class="col-md-2 col-sm-6 col-xs-12">
                <div class="widget footer-links">
                  ...
                  <ul class="list-no-dividers">                  
                    ...
                    <li><a href="/frontend/#">Specials</a></li>
                  </ul>
                </div>
              </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-6 copyright sm-text-center">
                <span>
                  &copy; 2023 Domas Store, Made by <a href="/frontend/http://deothemes.com">TangkasKrisna</a>
                </span>
              </div>

              <div class="footer-socials text-right"> <!-- Tambahkan kelas "text-right" -->
                <a href="/frontend/#"><i class="fa fa-twitter fa-lg"></i></a> <!-- Tambahkan kelas "fa-lg" untuk memperbesar ikon -->
                <a href="/frontend/#"><i class="fa fa-facebook fa-lg"></i></a>
                <a href="/frontend/#"><i class="fa fa-instagram fa-lg"></i></a>
              </div>

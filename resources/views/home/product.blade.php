    ...
    <div class="row">
      ...
      <div class="col-md-6 col-xs-12 product-description-wrap">
        <ol class="breadcrumb">
          ...
          <li>
            <a href="/product/{{$product->id_subkategoti}}">{{ $product->subcategory->nama_subkategori}}</a>
          </li>
          <li class="active">
            Catalog
          </li>
        ...
        <div class="product">
          <div class="product-item hover-trigger">
            ...
            <div class="product-details">                      
              ...
              <span class="category">
                <a href="/products/{{$produk->id_subkategori}}">{{$produk->subcategory->nama_sukategori}}</a>
              </span>
            </div>
            <span class="price">
              <ins>
